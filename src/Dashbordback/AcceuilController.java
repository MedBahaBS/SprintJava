...
public class AcceuilController implements Initializable {
    ...
    @FXML
    private void cour(MouseDragEvent event) throws IOException {
    ...
    @FXML
    private void imagesview(MouseDragEvent event) {
    }
