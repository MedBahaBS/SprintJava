    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_retour.setOnAction(event -> {
            ...
            try {
                ...
                Logger.getLogger(ClubFrontController.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        ...
        btn_affichert.setOnAction(event -> {
            ...
            try {
                Parent page2 = FXMLLoader.load(getClass().getResource("/view/AfficherClubsfront.fxml"));
