    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        btn_pie.setOnAction(event->{
            try {
                ...
                Logger.getLogger(AfficherClubsFrontController.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        
        btn_retour.setOnAction(event->{
            try {
                Parent pagePieChart=FXMLLoader.load(getClass().getResource("/view/clubfront.fxml"));
                Scene scene=new Scene(pagePieChart);
                Stage stage=(Stage) ((Node) event.getSource())
                        .getScene()
                        .getWindow();
